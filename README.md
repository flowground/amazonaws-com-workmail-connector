# ![LOGO](logo.png) Amazon WorkMail **flow**ground Connector

## Description

A generated **flow**ground connector for the Amazon WorkMail API (version 2017-10-01).
...
**flow**ground :- Telekom iPaaS / amazonaws-com-workmail-connector<br/>
